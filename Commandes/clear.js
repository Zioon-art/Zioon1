...
module.exports.run = async(client, message, args) => {
    ...
    if(!message.guild.member(message.author).hasPermission("MANAGE_MESSAGES")) return message.channel.send(`Vous n'avez pas la permission requise !`).catch(console.error);
